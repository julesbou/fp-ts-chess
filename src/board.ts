import type { Iso } from "monocle-ts/lib/Iso";
...
export const Column: Iso<Column, number> = {
  ...
  reverseGet: (column: number): Column =>
    "abcdefgh".split("")[column] as Column,
};
...
export const pieceFromSquare = (square: Square): string =>
